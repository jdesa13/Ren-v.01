...
if(WIN32)
 MESSAGE(STATUS "Searching for TBB... (win32)")
  foreach (_tbb_component ${TBB_FIND_COMPONENTS})
      MESSAGE("-------: " ${_tbb_component}) ########## TODO
      set(_tbb_release_lib "${TBB_CUSTOM_LIB_DIR}/Release/${_tbb_component}.dll")
      set(_tbb_debug_lib "${TBB_CUSTOM_LIB_DIR}/Debug/${_tbb_component}_debug.dll")
  
      if (EXISTS "${_tbb_release_lib}" OR EXISTS "${_tbb_debug_lib}")
          add_library(TBB::${_tbb_component} SHARED IMPORTED)
          set_target_properties(TBB::${_tbb_component} PROPERTIES
                                INTERFACE_INCLUDE_DIRECTORIES "${_tbb_root}/modules"
  ...
  IMPORTED_IMPLIB_RELEASE "${TBB_CUSTOM_LIB_DIR}/Release/${_tbb_component}.lib")
  ...
  IMPORTED_IMPLIB_DEBUG "${TBB_CUSTOM_LIB_DIR}/Debug/${_tbb_component}_debug.lib")
  ...
  MESSAGE(STATUS "Searching for TBB... (linux)")
  foreach (_tbb_component ${TBB_FIND_COMPONENTS})
      set(_tbb_release_lib "${TBB_CUSTOM_LIB_DIR}/tbb_cmake_build_subdir_release/lib${_tbb_component}.so.2")
      set(_tbb_debug_lib "${TBB_CUSTOM_LIB_DIR}/tbb_cmake_build_subdir_debug/lib${_tbb_component}_debug.so.2")
      ...
      if (EXISTS "${_tbb_release_lib}" OR EXISTS "${_tbb_debug_lib}")
          ...
          list(APPEND TBB_IMPORTED_TARGETS TBB::${_tbb_component})
          set(TBB_${_tbb_component}_FOUND 1)
          message(STATUS TBB_${_tbb_component}_FOUND)
      elseif (TBB_FIND_REQUIRED AND TBB_FIND_REQUIRED_${_tbb_component})
          message(FATAL_ERROR "Missed required Intel TBB component: ${_tbb_component}")
      endif()
  endforeach()
